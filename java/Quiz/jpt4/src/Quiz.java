...
public class Quiz implements Iterable
{
	 ...
	 *
	 * @param theItem; the original item which was passed in to be changed
	 *
	 * @param newItem; theItem which will be replacing theItem
	 */
	 ...
	 *
	 * @param num; the number passed in which is used to generate a randowm number
	 */
	 ...
	 *
	 * @param theItem; the item that is being added to the collection
	 */
     ...
     *
     * @param theItem; the item that is being removed
     */
